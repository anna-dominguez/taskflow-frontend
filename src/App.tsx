		...
		<div className="min-h-screen p-8 lg:p-12">
			...
			<header className="text-center text-white mb-16 animate-fade-in">
				<div className="inline-block backdrop-blur-md bg-white/10 rounded-3xl px-12 py-8 shadow-2xl border border-white/20">
					...
					<button
						type="button"
						className="mt-2 bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-mono shadow-lg cursor-pointer hover:bg-red-700 transition-colors duration-200"
						onClick={() => Sentry.captureException(new Error('Test Sentry'))}
					>
						Test Sentry
					</button>
					{totalTasks > 0 && (
